...
# API 에서도 시험할 수 없다.
PRODUCTS = [
    ("bc_1042", 88213, "[NEW/1등수분세럼] 토리든 다이브인 저분자 히알루론산 세럼 50ml 리필 기획(+리필 50ml)", 36000, 25650, 120, "ON_SALE"),
    ("bc_1042", 88214, "[세정이 쉬운 무기자차] 제로이드 이지워시 마일드 선크림 50ml", 32000, 24300, 80, "ON_SALE"),
    ("bc_1042", 88215, "[고데기필수템] 미쟝센 살롱10 펩타이드리페어 헤어밀크 에센스 150+50ML+브러쉬 증정기획", 24000, 18900, 0, "SOLD_OUT"),
    ("bc_1042", 88216, "[박희선Pick/대용량] 아누아 어성초 포어 컨트롤 클렌징오일 350ml", 29900, 21900, 45, "PENDING"),
    ("bc_1043", 88220, "[1+1] 이니스프리 비타민C 캡슐 세럼 30ml 더블 기획", 49000, 28910, 60, "ON_SALE"),
    ("bc_1043", 88221, "[호텔스파권증정/1등 모공수분천재크림] 에스네이처 아쿠아 스쿠알란 수분크림 60ml 기획(60ml+30ml)", 28000, 17900, 30, "ON_SALE"),
    ("bc_1050", 88230, "[8월올영픽]딜라이트 프로젝트 단백질쉐이크 45g 택1", 3900, 3700, 200, "PENDING"),
    ("bc_1051", 88240, "[덴프스X카카오프렌즈] 덴마크 유산균이야기 30캡슐 1+1 (+카카오프렌즈 키링) (60일분)", 40000, 32000, 150, "PENDING"),
    ("bc_1030", 88250, "[15년 연속 1위] 메디힐 에센셜 마스크팩 10/10+1매 기획 7종 골라담기", 20000, 10000, 0, "SOLD_OUT"),
]
