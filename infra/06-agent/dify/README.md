...
Lambda는 모델 context 폭주를 막기 위해 Dify 전송 직전에 제목 1,000자, 본문 6,000자,
쿼리 2,000자, 태그·링크 각 2,048자, 과거 사례 1,200자로 자른다. 원본 Datadog
이벤트와 S3 이력은 자르지 않으며, 이 제한은 LLM 입력에만 적용된다.
